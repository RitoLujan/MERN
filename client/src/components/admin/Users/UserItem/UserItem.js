...
export function UserItem(props) {
    ...
    const onDesactivateActivateConfirm = () =>{
        setIsDelete(false);
  ...
  return (
    <>
      <div className='user-item'>
        ...
        <div>
            <Button icon primary onClick={openUpdateUser}><Icon name='pencil' /></Button>
            <Button icon color={user.active ? "orange" : "teal"} onClick={onDesactivateActivateConfirm}><Icon name={user.active ? "ban" : "check"} /></Button>
            <Button icon color='red' onClick={openDeleteComfirm}><Icon name='trash' /></Button>
        </div>
      </div>
      ...
      <Confirm open={showComfirm} onCancel={onOpenCloseConfirm} onConfirm={isDelete ? onDelete : onActivateDesactivate} content={confirmMessage} size='mini' />
    </>
  );
}
