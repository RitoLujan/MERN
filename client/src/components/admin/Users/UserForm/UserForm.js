  ...
  return (
    <Form className='user-form' onSubmit={formik.handleSubmit}>
        ...
        <Form.Group widths="equal">
            ...
            <Form.Dropdown placeholder="Seleccióna un rol" options={roleOptions} selection onChange={(_, data) => formik.setFieldValue("role", data.value)} value={formik.values.role} error={formik.errors.role} />
        </Form.Group>
