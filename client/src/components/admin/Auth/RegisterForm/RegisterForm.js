...
export function RegisterForm(props) {
  ...
  return (
    <Form className='register-form' onSubmit={formik.handleSubmit}>
        ...
        <Form.Checkbox name='contidionsAccepted' label="He leído y acepto las políticas de privacidad" onChange={(_, data) => formik.setFieldValue("contidionsAccepted", data.checked)} checked={formik.values.contidionsAccepted} error={formik.errors.contidionsAccepted} />
